...
---
#Introduction
<p>The following analysis has been completed in order to find 'The Next GoTo Beer'. Our client, Dr. Santerre, is in need of a good beer and he has asked our team to complete an analysis on the list of breweries and beers in the United States.
</p>
...
<br /><b>Per below, there is a positive linear relationship between ABV and IBU. It is estimated that r^2 = 44.9% of the variation in the ABV is explained by the IBU.</b>
```{r}
ggplot(master, aes(x=IBU, y=ABV)) + geom_point() + labs(title="ABV to IBU", x ="IBU", y = "ABV")
cor.test(master$ABV,master$IBU)
```
#Conclusion
<p>
